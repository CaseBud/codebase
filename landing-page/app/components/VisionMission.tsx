          ...
          <div className="col-md-4">
            <div className="card h-100 p-4">
              <div className="card-body">
                ...
                <h3 className="h4 mb-3 card-header">Our Vision</h3>
          ...
          <div className="col-md-4">
            <div className="card h-100 p-4">
              <div className="card-body">
                ...
                <h3 className="h4 mb-3 card-header">Our Mission</h3>
                <p className="text-secondary">
                  To provide innovative legal technology that simplifies complex legal processes, enhances legal professionals&apos; efficiency,
                  and improves access to justice for all through advanced technological solutions.
                </p>
              </div>
            </div>
          </div>
          <div className="col-md-4">
            <div className="card h-100 p-4">
              <div className="card-body">
                ...
                <h3 className="h4 mb-3 card-header">Future Updates</h3>
                <ul className="text-secondary list-unstyled">
                  <li className="mb-2">✓ Streamline contract reviews, and other collaborative legal tasks</li>
