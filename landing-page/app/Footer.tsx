        ...
        <div className="row">
          ...
          <div className="col-6 col-md-2 mb-4">
            ...
            <ul className="nav flex-column">
              ...
              <li className="nav-item mb-2">
                <a href="https://app.readytensor.ai/publications/casebud-revolutionizing-legal-access-with-ai-driven-chatbot-technology-22VjtGRquRdq" className="nav-link p-0 text-muted">
                  Blog
                </a>
              </li>
